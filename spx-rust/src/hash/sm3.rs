...
pub fn prf_addr(out: &mut[u8], ctx: &SpxCtx, addr: &mut[u32])
{
  ...
  let mut buf = [0u8; SPX_SM3_ADDR_BYTES + SPX_N];
  ...
  buf[..SPX_SM3_ADDR_BYTES]
    .copy_from_slice(&addr_bytes[..SPX_SM3_ADDR_BYTES]);
  buf[SPX_SM3_ADDR_BYTES..SPX_SM3_ADDR_BYTES+SPX_N]
